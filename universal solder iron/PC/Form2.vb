...
Public Class Form2
    ...
    Delegate Sub tlmrcb1(ByVal b() As Byte)
    Private Sub ud_DataReceived(ByVal b() As Byte) Handles lUniSolder.LiveDataReceived
        Dim i As Integer
        'Dim s As String
        'Dim b(64) As Byte
        If SsChart2.InvokeRequired Then
            Dim d As New tlmrcb1(AddressOf ud_DataReceived)
            Try
                Me.BeginInvoke(d, b) 'New Object() {})
            Catch ex As Exception
                Debug.Print("EXEXEXEX")
                Exit Try
            End Try
        Else
            Select Case b(0)
                Case 3
                    ...
                    Else
                        If Button8.Text <> "START" Then
                            ...
                            SsChart2.Drawings(8).Points(CPoint).Y = b(10) * 1.0 + b(11) * 256.0 'CHRes
                            ...
                            SsChart2.Drawings(12).Points(CPoint).Y = (b(34) * 1.0 + b(35) * 256.0 - 2048.0) + 250.0
                ...
                Case 4
                    ...
                    Else
                        i = b(1) + b(2) * 256
                        KpTrackBar.Value = i * 100 / 32768
                        i = b(3) + b(4) * 256
                        KiTrackBar.Value = i * 1000 / 32768
                        DGTrackBar.Value = b(5)
                        OVFGTrackBar.Value = b(6)
                        GTrackBar.Value = b(7) + b(8) * 256
                    End If
            End Select
    ...
    Private Sub GTrackBar_ValueChanged(sender As System.Object, e As System.EventArgs) Handles GTrackBar.ValueChanged
        GLabel.Text = "OVFGain = " & Format(GTrackBar.Value)
    End Sub
